...
# TechWomen Exercise 1 : Execute the code with the command `python 00_my_first_project.py`

# TechWomen Exercise 2: Update the text value to something you want to show on the screen and execute the code again.
